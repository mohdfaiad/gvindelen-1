...
function olymp_get_events(&$tournir_node, $sport_sign, $tournir_id, $debug = null) {
  $booker = 'olymp';
...
function olymp_load_sport($sport_sign) {
  ...
  foreach($sport_node as $tournir_node) olymp_get_events($tournir_node, $sport_sign, $tournir_node['Id'], $debug);
