...
//        SelectClipRgn(Handle, 0);
  ...
  procedure DrawTreeArea(Canvas: TCanvas; ARect: TRect);
    ...
    begin
      ...
      DrawTreeElement(Canvas, ARect, TreeElement, False, fScaleX, fScaleY, DBGridEh.UseRightToLeftAlignment, False);
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          DrawTreeElement(VPrinter_Canvas, ARect1, TreeElement, True, fScaleX, fScaleY, DBGridEh.UseRightToLeftAlignment, False);
      ...
      FColCellParamsEh.Text := ADrawGroupDataNode.DataGroup.GetGroupRowText(ADrawGroupDataNode);
      FColCellParamsEh.Alignment := taLeftJustify;
      VPrinter_Canvas.Font := ADrawGroupDataNode.DataGroup.Font;
