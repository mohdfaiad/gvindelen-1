...
begin
  ...
  if pbp.ShowText and (progressText <> '') then
    begin
      ...
      textSise := Canvas.TextExtent(progressText);
      if (PBParPtr = nil) and (textSise.cy >= textRect.Bottom - textRect.Top) and (Color <> FrameColor) then
      begin
      ...
      textRect := Rect;
      textRect.Left := Rect.Left + ((Rect.Right - Rect.Left) shr 1) - (textSise.cx shr 1);
      textRect.Top := Rect.Top + ((Rect.Bottom - Rect.Top) shr 1) - (textSise.cy shr 1);
      textRect.Right := textRect.Left + textSise.cx;
      textRect.Bottom := textRect.Top + textSise.cy;
