...
const
  Sig: {$IFNDEF CLR} PAnsiChar {$ELSE} AnsiString {$ENDIF} =
    ...
    {$IFNDEF BCB} {$IFDEF VER200} '/D12'+ {$ENDIF} {$ELSE} {$IFDEF VER200} '/CB12'+ {$ENDIF} {$ENDIF}
    {$IFNDEF BCB} {$IFDEF VER210} '/D14'+ {$ENDIF} {$ELSE} {$IFDEF VER210} '/CB14'+ {$ENDIF} {$ENDIF}
    {$IFNDEF BCB} {$IFDEF VER220} '/D15'+ {$ENDIF} {$ELSE} {$IFDEF VER220} '/CB15'+ {$ENDIF} {$ENDIF}
    {$IFNDEF BCB} {$IFDEF VER230} '/D16'+ {$ENDIF} {$ELSE} {$IFDEF VER230} '/CB16'+ {$ENDIF} {$ENDIF}
