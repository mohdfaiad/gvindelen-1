...
rem Compile IBDAC packages ===========================================
%IdeDir%\Bin\dccil.exe" -LE. Devart.IbDac.dpk
@if errorlevel 1 goto Err

%IdeDir%\Bin\dccil.exe" -LE. Devart.IbDac.AdoNet.dpk
@if errorlevel 1 goto Err

%IdeDir%\Bin\dccil.exe" -LE. Devart.IbDac.Design.dpk
@if errorlevel 1 goto Err
