...
begin
{$IFDEF UNIX}
  cbStoredProcName.OnGetItems := nil;
  cbStoredProcNameSP.OnGetItems := nil;
  try
{$ENDIF}
  try
...
{$IFDEF UNIX}
    ...
    cbStoredProcName.OnGetItems := cbStoredProcNameDropDown;
    cbStoredProcNameSP.OnGetItems := cbStoredProcNameDropDown;
  end;
{$ENDIF}
end;
