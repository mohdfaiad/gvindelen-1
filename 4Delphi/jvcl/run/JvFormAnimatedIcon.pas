...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvFormAnimatedIcon.pas 195 2011-08-16 12:23:51Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvFormAnimatedIcon.pas $';
    Revision: '$Revision: 195 $';
    Date: '$Date: 2011-08-16 14:23:51 +0200 (mar., 16 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
