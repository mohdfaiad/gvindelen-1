...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvTFSparseMatrix.pas 111 2011-07-24 13:55:42Z uschuster $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvTFSparseMatrix.pas $';
    Revision: '$Revision: 111 $';
    Date: '$Date: 2011-07-24 15:55:42 +0200 (dim., 24 juil. 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
