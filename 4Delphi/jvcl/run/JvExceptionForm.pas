...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvExceptionForm.pas 225 2011-08-25 20:13:05Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvExceptionForm.pas $';
    Revision: '$Revision: 225 $';
    Date: '$Date: 2011-08-25 22:13:05 +0200 (jeu., 25 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
