...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDBLookupTreeView.pas 227 2011-08-25 20:16:53Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvDBLookupTreeView.pas $';
    Revision: '$Revision: 227 $';
    Date: '$Date: 2011-08-25 22:16:53 +0200 (jeu., 25 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
