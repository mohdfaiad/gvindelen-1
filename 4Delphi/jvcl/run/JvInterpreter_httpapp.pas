...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvInterpreter_httpapp.pas 56 2011-05-28 17:40:01Z andypulsar $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvInterpreter_httpapp.pas $';
    Revision: '$Revision: 56 $';
    Date: '$Date: 2011-05-28 19:40:01 +0200 (sam., 28 mai 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
