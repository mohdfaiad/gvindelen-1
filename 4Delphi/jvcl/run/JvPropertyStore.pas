...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvPropertyStore.pas 210 2011-08-25 06:21:26Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile:
      '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvPropertyStore.pas $';
    Revision: '$Revision: 210 $';
    Date: '$Date: 2011-08-25 08:21:26 +0200 (jeu., 25 août 2011) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
