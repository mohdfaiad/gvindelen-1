...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvPaintFX.pas 229 2011-08-25 20:20:37Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvPaintFX.pas $';
    Revision: '$Revision: 229 $';
    Date: '$Date: 2011-08-25 22:20:37 +0200 (jeu., 25 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
