...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvPageSetup.pas 238 2011-08-28 13:53:40Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvPageSetup.pas $';
    Revision: '$Revision: 238 $';
    Date: '$Date: 2011-08-28 15:53:40 +0200 (dim., 28 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
