...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JVCLVer.pas 168 2011-08-12 07:54:55Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JVCLVer.pas $';
    Revision: '$Revision: 168 $';
    Date: '$Date: 2011-08-12 09:54:55 +0200 (ven., 12 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
