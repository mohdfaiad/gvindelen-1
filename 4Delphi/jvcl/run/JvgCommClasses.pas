...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvgCommClasses.pas 148 2011-08-09 15:06:02Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvgCommClasses.pas $';
    Revision: '$Revision: 148 $';
    Date: '$Date: 2011-08-09 17:06:02 +0200 (mar., 09 aoГ»t 2011) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
