...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDockSupportClass.pas 44 2011-05-04 19:41:09Z uschuster $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvDockSupportClass.pas $';
    Revision: '$Revision: 44 $';
    Date: '$Date: 2011-05-04 21:41:09 +0200 (mer., 04 mai 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
