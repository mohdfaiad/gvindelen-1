...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvRecentMenuButton.pas 196 2011-08-16 12:53:33Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvRecentMenuButton.pas $';
    Revision: '$Revision: 196 $';
    Date: '$Date: 2011-08-16 14:53:33 +0200 (mar., 16 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
