...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDockSupportControl.pas 164 2011-08-11 10:20:22Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvDockSupportControl.pas $';
    Revision: '$Revision: 164 $';
    Date: '$Date: 2011-08-11 12:20:22 +0200 (jeu., 11 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
