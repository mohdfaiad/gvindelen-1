...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvAddPrinter.pas 201 2011-08-16 13:30:36Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvAddPrinter.pas $';
    Revision: '$Revision: 201 $';
    Date: '$Date: 2011-08-16 15:30:36 +0200 (mar., 16 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
