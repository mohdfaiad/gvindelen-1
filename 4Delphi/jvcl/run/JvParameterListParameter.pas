...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvParameterListParameter.pas 39 2011-04-02 11:12:40Z uschuster $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvParameterListParameter.pas $';
    Revision: '$Revision: 39 $';
    Date: '$Date: 2011-04-02 13:12:40 +0200 (sam., 02 avr. 2011) $';
    LogPath: 'JVCL\run'
    );
  {$ENDIF UNITVERSIONING}
