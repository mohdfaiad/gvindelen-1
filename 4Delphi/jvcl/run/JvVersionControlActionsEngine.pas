...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvVersionControlActionsEngine.pas 133 2011-07-31 13:52:49Z uschuster $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvVersionControlActionsEngine.pas $';
    Revision: '$Revision: 133 $';
    Date: '$Date: 2011-07-31 15:52:49 +0200 (dim., 31 juil. 2011) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
