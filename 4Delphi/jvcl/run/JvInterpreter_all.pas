...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvInterpreter_all.pas 125 2011-07-29 15:09:44Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvInterpreter_all.pas $';
    Revision: '$Revision: 125 $';
    Date: '$Date: 2011-07-29 17:09:44 +0200 (ven., 29 juil. 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
