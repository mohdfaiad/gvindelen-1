...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvInterpreter_Graphics.pas 124 2011-07-29 15:02:20Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvInterpreter_Graphics.pas $';
    Revision: '$Revision: 124 $';
    Date: '$Date: 2011-07-29 17:02:20 +0200 (ven., 29 juil. 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
