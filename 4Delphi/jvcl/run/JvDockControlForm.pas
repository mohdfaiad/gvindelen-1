...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvDockControlForm.pas 228 2011-08-25 20:18:25Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvDockControlForm.pas $';
    Revision: '$Revision: 228 $';
    Date: '$Date: 2011-08-25 22:18:25 +0200 (jeu., 25 août 2011) $';
    LogPath: 'JVCL\run'
    );
{$ENDIF UNITVERSIONING}
