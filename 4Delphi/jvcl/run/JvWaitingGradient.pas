...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvWaitingGradient.pas 197 2011-08-16 12:59:53Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvWaitingGradient.pas $';
    Revision: '$Revision: 197 $';
    Date: '$Date: 2011-08-16 14:59:53 +0200 (mar., 16 aoÃ»t 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
