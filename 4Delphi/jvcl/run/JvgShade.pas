...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvgShade.pas 188 2011-08-16 10:01:52Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvgShade.pas $';
    Revision: '$Revision: 188 $';
    Date: '$Date: 2011-08-16 12:01:52 +0200 (mar., 16 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
