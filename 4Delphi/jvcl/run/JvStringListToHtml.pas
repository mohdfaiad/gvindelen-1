...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvStringListToHtml.pas 198 2011-08-16 13:03:39Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvStringListToHtml.pas $';
    Revision: '$Revision: 198 $';
    Date: '$Date: 2011-08-16 15:03:39 +0200 (mar., 16 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
