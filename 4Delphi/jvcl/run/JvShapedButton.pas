...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvShapedButton.pas 230 2011-08-25 20:22:46Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvShapedButton.pas $';
    Revision: '$Revision: 230 $';
    Date: '$Date: 2011-08-25 22:22:46 +0200 (jeu., 25 août 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
