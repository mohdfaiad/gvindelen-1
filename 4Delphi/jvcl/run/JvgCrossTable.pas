...
Known Issues:
-----------------------------------------------------------------------------}
// $Id: JvgCrossTable.pas 122 2011-07-29 14:50:12Z obones $
...
const
  UnitVersioning: TUnitVersionInfo = (
    RCSfile: '$URL: https://vcstest.delphi-jedi.org:4443/svn/pulsar/trunk/jvcl/run/JvgCrossTable.pas $';
    Revision: '$Revision: 122 $';
    Date: '$Date: 2011-07-29 16:50:12 +0200 (ven., 29 juil. 2011) $';
    LogPath: 'JVCL\run'
  );
{$ENDIF UNITVERSIONING}
