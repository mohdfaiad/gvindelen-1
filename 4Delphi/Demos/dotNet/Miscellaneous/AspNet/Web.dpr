...
{%DelphiDotNetAssemblyCompiler 'System.Web.dll'}
{%DelphiDotNetAssemblyCompiler 'System.XML.dll'}
{%DelphiDotNetAssemblyCompiler 'Devart.IbDac.AdoNet.dll'}
{%AspMarkupContainer 'Global.asax'}
{%AspMarkupContainer 'WebForm.aspx'}
{$R 'WebForm.resx'}
{%File 'ModelSupport\Global\Global.txvpck'}
{%File 'ModelSupport\WebForm\WebForm.txvpck'}
