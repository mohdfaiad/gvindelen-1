...
uses
  ...
  DB, IBC, DBAccess, IbDacVcl, Devart.IbDac.DataAdapter;
...
type
  ...
  strict private
    ...
    IBCDataAdapter1: Devart.IbDac.DataAdapter.IBCDataAdapter;
...
begin
        ...
        Self.IBCDataAdapter1 := Devart.IbDac.DataAdapter.IBCDataAdapter.Create;
        ...
        // IBCDataAdapter1
        // 
        Self.IBCDataAdapter1.DataSet := nil;
        Self.IBCDataAdapter1.Name := '';
        Self.IBCDataAdapter1.Tag := nil;
        // 
        // btUpdate
        // 
        ...
        Self.Name := 'TMainForm';
        Self.Text := 'IbDac .NET demo - using DataSet component';
...
begin
  ...
  //
  InitializeComponent;
  ConnectDialog := TIBCConnectDialog.Create(nil);
  ...
  with IBCQuery do begin
    ...
    SQL.Text := 'select a.* from dept a';
  end;
  IBCDataAdapter1.DataSet := IBCQuery;
end;

procedure TMainForm.btUpdate_Click(sender: System.Object; e: System.EventArgs);
begin
  IBCDataAdapter1.Update(dataSet, 'Table1');
end;
...
begin
  IBCDataAdapter1.Fill(dataSet, 'Table1');
