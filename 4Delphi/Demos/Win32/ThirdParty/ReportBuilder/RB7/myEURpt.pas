...
{$ENDIF}
  ...
  ppStrtch, ppDsgnDB, ppTypes, IBCScript, ppFormWrapper, daDataView, daQueryDataView, ppModule,
  daDataModule, ppCtrls, ppVar, ppRelatv, MemDS, DBAccess, IBC,ppViewr, daDatMod,
  daDataVw, daQuery, daQClass, ppDBBDE, IbdacVcl, DAScript;
...
type
  TmyEndUserSolution = class(TForm)
    ...
    ppLabel4: TppLabel;
    ppShape1: TppShape;
    IBDACQueryDataView1: TdaIBDACQueryDataView;
