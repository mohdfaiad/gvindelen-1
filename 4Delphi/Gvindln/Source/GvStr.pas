...
function Translit(St: string): string;
const
  Rus='АБВГДЕЖЗИЙКЛМНОПРСТУФХЦЪЫЭабвгдежзийклмнопрстуфхцъыэ';
...
begin
  ...
  try
    Mapping.Text:= ReplaceAll('Лю=Liu;лю=liu;ё=yo;Ч=Ch;ч=ch;Ш=Sh;ш=sh;Щ=Sch;щ=sch;Ю=Yu;ю=yu;Я=Ya;я=ya;ь=', ';', #13#10);
