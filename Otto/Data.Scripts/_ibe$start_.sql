/******************************************************************************/
/***          Generated by IBExpert 2012.9.2.1 01.08.2013 2:12:38           ***/
/******************************************************************************/
...
CREATE DOMAIN ADDRESS_DELIVERY AS
...
SET GENERATOR SEQ_PLACE_ID TO 1000198;
...
SET GENERATOR SEQ_SEARCH_ID TO 8350;

CREATE GENERATOR SEQ_SETTING_ID;
SET GENERATOR SEQ_SETTING_ID TO 581;
...
CREATE TABLE CLIENTNOTIFIES (
    CLIENTNOTIFY_ID    ID_NOTIFY NOT NULL,
    CLIENT_ID          ID_CLIENT NOT NULL,
...
CREATE TABLE DEALERNOTIFIES (
    DEALERNOTIFY_ID  ID_NOTIFY NOT NULL,
...
CREATE TABLE PACKLISTS (
    PACKLIST_NO    VALUE_INTEGER NOT NULL,
...
CREATE TABLE PRODUCTS (
    ...
    STATUS_ID             ID_STATUS,
    STATUS_DTM            DTM_STATUS,
    PAYTYPE_SIGN          SIGN_OBJECT,
    MANUAL_BAR_CODE_ABLE  CODE_ACTION,
    PARTNER_NUMBER        SIGN_OBJECT
);

CREATE TABLE RECODE_MASKS (
    OBJECT_SIGN   SIGN_OBJECT NOT NULL,
    ATTR_SIGN     SIGN_ATTR NOT NULL,
    SEARCH_MASK   MASK_ARTICLECODE NOT NULL,
    REPLACE_MASK  MASK_ARTICLECODE
);
