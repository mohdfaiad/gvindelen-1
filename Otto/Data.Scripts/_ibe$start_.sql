/******************************************************************************/
/***          Generated by IBExpert 2012.02.21 20.09.2012 11:14:40          ***/
/******************************************************************************/
...
SET GENERATOR SEQ_EVENT_ID TO 3731;

CREATE GENERATOR SEQ_INVOICE_ID;
SET GENERATOR SEQ_INVOICE_ID TO 78;

CREATE GENERATOR SEQ_LOG_ID;
SET GENERATOR SEQ_LOG_ID TO 335130;

CREATE GENERATOR SEQ_MAGAZINE_ID;
SET GENERATOR SEQ_MAGAZINE_ID TO 47;

CREATE GENERATOR SEQ_MESSAGE_ID;
SET GENERATOR SEQ_MESSAGE_ID TO 75333;

CREATE GENERATOR SEQ_MONEYBACK_ID;
SET GENERATOR SEQ_MONEYBACK_ID TO 108;

CREATE GENERATOR SEQ_NOTIFY_ID;
SET GENERATOR SEQ_NOTIFY_ID TO 1455980;

CREATE GENERATOR SEQ_ORDERITEM_ID;
SET GENERATOR SEQ_ORDERITEM_ID TO 19715;

CREATE GENERATOR SEQ_ORDERMONEY_ID;
SET GENERATOR SEQ_ORDERMONEY_ID TO 2343;

CREATE GENERATOR SEQ_ORDERTAX_ID;
SET GENERATOR SEQ_ORDERTAX_ID TO 4623;

CREATE GENERATOR SEQ_ORDER_ID;
SET GENERATOR SEQ_ORDER_ID TO 4902;

CREATE GENERATOR SEQ_PARAM_ID;
SET GENERATOR SEQ_PARAM_ID TO 1812462;
...
SET GENERATOR SEQ_PLACE_ID TO 1000064;
...
SET GENERATOR SEQ_SEARCH_ID TO 4509;

CREATE GENERATOR SEQ_SETTING_ID;
SET GENERATOR SEQ_SETTING_ID TO 331;
