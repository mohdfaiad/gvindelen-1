...
begin
  ...
  begin
    ...
    insert into accopers (account_id, amount_eur, byr2eur, amount_byr, order_id, notes)
      values(:i_object_id, -:v_acc_amount_eur, :v_acc_byr2eur, :v_amount_byr, :v_order_id, :v_notes);
    insert into ordermoneys (account_id, amount_eur, byr2eur, order_id, amount_byr)
      values(:i_object_id, :v_acc_amount_eur, :v_acc_byr2eur, :v_order_id, :v_amount_byr);
...
/* DROP: -- GRANT RDB$ADMIN TO NASTYA */
SET TERM ; ^

REVOKE RDB$ADMIN FROM NASTYA;

/* Create(Add) privilege */
GRANT ALL ON ACCRESTS TO ANNA;

GRANT ALL ON ACCRESTS TO ELENA;

GRANT ALL ON ACCRESTS TO KATYA;

GRANT ALL ON ACCRESTS TO LENA;

GRANT ALL ON ACCRESTS TO NASTYA17;

GRANT ALL ON ACCRESTS TO NATVL;

GRANT ALL ON ACCRESTS TO ND;

GRANT ALL ON ACCRESTS TO YULYA;

GRANT ALL ON IMP_CLIENT3 TO ELENA;

GRANT ALL ON IMP_CLIENT3 TO NASTYA17;

GRANT ALL ON IMP_CLIENT3 TO NATVL;

GRANT ALL ON IMP_CLIENT3 TO ND;

GRANT ALL ON IMP_CLIENT3 TO YULYA;

GRANT ALL ON MONEYBACK_ATTRS TO ANNA;

GRANT ALL ON MONEYBACK_ATTRS TO ELENA;

GRANT ALL ON MONEYBACK_ATTRS TO KATYA;

GRANT ALL ON MONEYBACK_ATTRS TO LENA;

GRANT ALL ON MONEYBACK_ATTRS TO NASTYA17;

GRANT ALL ON MONEYBACK_ATTRS TO NATVL;

GRANT ALL ON MONEYBACK_ATTRS TO ND;

GRANT ALL ON MONEYBACK_ATTRS TO YULYA;

GRANT ALL ON MONEYBACKS TO ANNA;

GRANT ALL ON MONEYBACKS TO ELENA;

GRANT ALL ON MONEYBACKS TO KATYA;

GRANT ALL ON MONEYBACKS TO LENA;

GRANT ALL ON MONEYBACKS TO NASTYA17;

GRANT ALL ON MONEYBACKS TO NATVL;

GRANT ALL ON MONEYBACKS TO ND;

GRANT ALL ON MONEYBACKS TO YULYA;

GRANT ALL ON V_ACCRESTS TO ANNA;

GRANT ALL ON V_ACCRESTS TO ELENA;

GRANT ALL ON V_ACCRESTS TO KATYA;

GRANT ALL ON V_ACCRESTS TO LENA;

GRANT ALL ON V_ACCRESTS TO NASTYA17;

GRANT ALL ON V_ACCRESTS TO NATVL;

GRANT ALL ON V_ACCRESTS TO ND;

GRANT ALL ON V_ACCRESTS TO YULYA;

GRANT ALL ON V_CLIENT_BANKINFO TO ANNA;

GRANT ALL ON V_CLIENT_BANKINFO TO ELENA;

GRANT ALL ON V_CLIENT_BANKINFO TO KATYA;

GRANT ALL ON V_CLIENT_BANKINFO TO LENA;

GRANT ALL ON V_CLIENT_BANKINFO TO NASTYA17;

GRANT ALL ON V_CLIENT_BANKINFO TO NATVL;

GRANT ALL ON V_CLIENT_BANKINFO TO ND;

GRANT ALL ON V_CLIENT_BANKINFO TO YULYA;

GRANT ALL ON V_MONEYBACK_ATTRS TO ANNA;

GRANT ALL ON V_MONEYBACK_ATTRS TO ELENA;

GRANT ALL ON V_MONEYBACK_ATTRS TO KATYA;

GRANT ALL ON V_MONEYBACK_ATTRS TO LENA;

GRANT ALL ON V_MONEYBACK_ATTRS TO NASTYA17;

GRANT ALL ON V_MONEYBACK_ATTRS TO NATVL;

GRANT ALL ON V_MONEYBACK_ATTRS TO ND;

GRANT ALL ON V_MONEYBACK_ATTRS TO YULYA;

GRANT ALL ON V_MONEYBACK_BANK TO ANNA;

GRANT ALL ON V_MONEYBACK_BANK TO ELENA;

GRANT ALL ON V_MONEYBACK_BANK TO KATYA;

GRANT ALL ON V_MONEYBACK_BANK TO LENA;

GRANT ALL ON V_MONEYBACK_BANK TO NASTYA17;

GRANT ALL ON V_MONEYBACK_BANK TO NATVL;

GRANT ALL ON V_MONEYBACK_BANK TO ND;

GRANT ALL ON V_MONEYBACK_BANK TO YULYA;

GRANT ALL ON V_PRODUCT_ATTRS TO ANNA;

GRANT ALL ON V_PRODUCT_ATTRS TO ELENA;

GRANT ALL ON V_PRODUCT_ATTRS TO KATYA;

GRANT ALL ON V_PRODUCT_ATTRS TO LENA;

GRANT ALL ON V_PRODUCT_ATTRS TO NASTYA17;

GRANT ALL ON V_PRODUCT_ATTRS TO NATVL;

GRANT ALL ON V_PRODUCT_ATTRS TO ND;

GRANT ALL ON V_PRODUCT_ATTRS TO YULYA;

GRANT ALL ON WAYS TO ANNA;

GRANT ALL ON WAYS TO ELENA;

GRANT ALL ON WAYS TO KATYA;

GRANT ALL ON WAYS TO LENA;

GRANT ALL ON WAYS TO NASTYA17;

GRANT ALL ON WAYS TO NATVL;

GRANT ALL ON WAYS TO ND;

GRANT ALL ON WAYS TO YULYA;

GRANT EXECUTE ON PROCEDURE ACT_ACCOUNT_PAYMENTOUT TO ANNA;

GRANT EXECUTE ON PROCEDURE ACT_ACCOUNT_PAYMENTOUT TO ELENA;

GRANT EXECUTE ON PROCEDURE ACT_ACCOUNT_PAYMENTOUT TO KATYA;

GRANT EXECUTE ON PROCEDURE ACT_ACCOUNT_PAYMENTOUT TO LENA;

GRANT EXECUTE ON PROCEDURE ACT_ACCOUNT_PAYMENTOUT TO NASTYA17;

GRANT EXECUTE ON PROCEDURE ACT_ACCOUNT_PAYMENTOUT TO NATVL;

GRANT EXECUTE ON PROCEDURE ACT_ACCOUNT_PAYMENTOUT TO ND;

GRANT EXECUTE ON PROCEDURE ACT_ACCOUNT_PAYMENTOUT TO YULYA;

GRANT EXECUTE ON PROCEDURE ACT_MONEYBACK_STORE TO ANNA;

GRANT EXECUTE ON PROCEDURE ACT_MONEYBACK_STORE TO ELENA;

GRANT EXECUTE ON PROCEDURE ACT_MONEYBACK_STORE TO KATYA;

GRANT EXECUTE ON PROCEDURE ACT_MONEYBACK_STORE TO LENA;

GRANT EXECUTE ON PROCEDURE ACT_MONEYBACK_STORE TO NASTYA17;

GRANT EXECUTE ON PROCEDURE ACT_MONEYBACK_STORE TO NATVL;

GRANT EXECUTE ON PROCEDURE ACT_MONEYBACK_STORE TO ND;

GRANT EXECUTE ON PROCEDURE ACT_MONEYBACK_STORE TO YULYA;

GRANT EXECUTE ON PROCEDURE ACTION_REEXECUTE TO ELENA;

GRANT EXECUTE ON PROCEDURE ACTION_REEXECUTE TO NASTYA17;

GRANT EXECUTE ON PROCEDURE ACTION_REEXECUTE TO NATVL;

GRANT EXECUTE ON PROCEDURE ACTION_REEXECUTE TO ND;

GRANT EXECUTE ON PROCEDURE ACTION_REEXECUTE TO YULYA;

GRANT EXECUTE ON PROCEDURE DB_CLEANUP TO ANNA;

GRANT EXECUTE ON PROCEDURE DB_CLEANUP TO ELENA;

GRANT EXECUTE ON PROCEDURE DB_CLEANUP TO KATYA;

GRANT EXECUTE ON PROCEDURE DB_CLEANUP TO LENA;

GRANT EXECUTE ON PROCEDURE DB_CLEANUP TO NASTYA17;

GRANT EXECUTE ON PROCEDURE DB_CLEANUP TO NATVL;

GRANT EXECUTE ON PROCEDURE DB_CLEANUP TO ND;

GRANT EXECUTE ON PROCEDURE DB_CLEANUP TO YULYA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_READ TO ANNA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_READ TO ELENA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_READ TO KATYA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_READ TO LENA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_READ TO NASTYA17;

GRANT EXECUTE ON PROCEDURE MONEYBACK_READ TO NATVL;

GRANT EXECUTE ON PROCEDURE MONEYBACK_READ TO ND;

GRANT EXECUTE ON PROCEDURE MONEYBACK_READ TO YULYA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_X_PURPOSE TO ANNA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_X_PURPOSE TO ELENA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_X_PURPOSE TO KATYA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_X_PURPOSE TO LENA;

GRANT EXECUTE ON PROCEDURE MONEYBACK_X_PURPOSE TO NASTYA17;

GRANT EXECUTE ON PROCEDURE MONEYBACK_X_PURPOSE TO NATVL;

GRANT EXECUTE ON PROCEDURE MONEYBACK_X_PURPOSE TO ND;

GRANT EXECUTE ON PROCEDURE MONEYBACK_X_PURPOSE TO YULYA;

GRANT EXECUTE ON PROCEDURE ORDER_ANUL TO ELENA;

GRANT EXECUTE ON PROCEDURE ORDER_ANUL TO NASTYA17;

GRANT EXECUTE ON PROCEDURE ORDER_ANUL TO NATVL;

GRANT EXECUTE ON PROCEDURE ORDER_ANUL TO ND;

GRANT EXECUTE ON PROCEDURE ORDER_ANUL TO YULYA;

GRANT EXECUTE ON PROCEDURE PARAM_MERGE TO ANNA;

GRANT EXECUTE ON PROCEDURE PARAM_MERGE TO ELENA;

GRANT EXECUTE ON PROCEDURE PARAM_MERGE TO KATYA;

GRANT EXECUTE ON PROCEDURE PARAM_MERGE TO LENA;

GRANT EXECUTE ON PROCEDURE PARAM_MERGE TO NASTYA17;

GRANT EXECUTE ON PROCEDURE PARAM_MERGE TO NATVL;

GRANT EXECUTE ON PROCEDURE PARAM_MERGE TO ND;

GRANT EXECUTE ON PROCEDURE PARAM_MERGE TO YULYA;

GRANT EXECUTE ON PROCEDURE TAX_ENTERED_SUM TO ANNA;

GRANT EXECUTE ON PROCEDURE TAX_ENTERED_SUM TO ELENA;

GRANT EXECUTE ON PROCEDURE TAX_ENTERED_SUM TO KATYA;

GRANT EXECUTE ON PROCEDURE TAX_ENTERED_SUM TO LENA;

GRANT EXECUTE ON PROCEDURE TAX_ENTERED_SUM TO NASTYA17;

GRANT EXECUTE ON PROCEDURE TAX_ENTERED_SUM TO NATVL;

GRANT EXECUTE ON PROCEDURE TAX_ENTERED_SUM TO ND;

GRANT EXECUTE ON PROCEDURE TAX_ENTERED_SUM TO YULYA;
