...
CREATE PROCEDURE ACCOUNT_RECALCREST(I_ACCOUNT_ID TYPE OF ID_ACCOUNT NOT NULL)
 AS
 BEGIN EXIT; END
^

CREATE PROCEDURE BONUS_USE(I_ORDER_CODE TYPE OF CODE_ORDER)
...
/* Restore proc. body: ACCOUNT_RECALCREST */
ALTER PROCEDURE ACCOUNT_RECALCREST(I_ACCOUNT_ID TYPE OF ID_ACCOUNT NOT NULL)
 AS
begin
