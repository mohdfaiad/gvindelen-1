...
ALTER PROCEDURE ACT_INVOICE_STORE(I_PARAM_ID TYPE OF ID_PARAM,
...
ALTER PROCEDURE ACT_ORDERITEM_PAY(I_PARAM_ID TYPE OF ID_PARAM,
I_OBJECT_ID TYPE OF ID_OBJECT,
...
ALTER PROCEDURE INVOICE_DETECT(I_PAY_DT TYPE OF DT_INVOICE,
I_AMOUNT_BYR TYPE OF MONEY_BYR,
I_INVOICE_CODE TYPE OF CODE_ORDER)
 RETURNS(O_INVOICE_ID TYPE OF ID_INVOICE)
 AS
 BEGIN SUSPEND; END
^

ALTER PROCEDURE INVOICE_GET_UNPAYED(I_AMOUNT_BYR TYPE OF MONEY_BYR,
...
ALTER PROCEDURE ORDER_X_UNPAID(I_DEST_PARAM_ID TYPE OF ID_PARAM,
...
ALTER PROCEDURE ACT_ACCOUNT_STORE(I_PARAM_ID TYPE OF ID_PARAM,
I_OBJECT_ID TYPE OF ID_OBJECT,
...
CREATE PROCEDURE ACT_ACCOUNT_CREDIT(I_PARAM_ID TYPE OF ID_PARAM,
I_OBJECT_ID TYPE OF ID_OBJECT,
I_OBJECT_SIGN TYPE OF SIGN_OBJECT = 'ACCOUNT')
 AS
 BEGIN EXIT; END
...
CREATE PROCEDURE ACT_ACCOUNT_CREDITORDER(I_PARAM_ID TYPE OF ID_PARAM,
I_OBJECT_ID TYPE OF ID_OBJECT,
I_OBJECT_SIGN TYPE OF SIGN_OBJECT = 'ACCOUNT')
 AS
 BEGIN EXIT; END
...
CREATE PROCEDURE ACT_ACCOUNT_DEBIT(I_PARAM_ID TYPE OF ID_PARAM,
I_OBJECT_ID TYPE OF ID_OBJECT,
I_OBJECT_SIGN TYPE OF SIGN_OBJECT = 'ACCOUNT')
 AS
 BEGIN EXIT; END
...
CREATE PROCEDURE ACT_ACCOUNT_PAYMENTIN(I_PARAM_ID TYPE OF ID_PARAM,
I_OBJECT_ID TYPE OF ID_OBJECT,
I_OBJECT_SIGN TYPE OF SIGN_OBJECT = 'ACCOUNT')
 AS
 BEGIN EXIT; END
...
CREATE PROCEDURE PARAM_FILLPATTERN(I_PARAM_ID TYPE OF ID_PARAM,
...
/* Create Views... */
/* Create view: V_ORDER_FULL_SPECIFICATION (ViwData.CreateDependDef) */
SET TERM ; ^
...
/* Create view: V_ORDER_INVOICEABLE (ViwData.CreateDependDef) */
...
/* Create view: V_ORDER_SUMMARY (ViwData.CreateDependDef) */
...
/* Restore proc. body: ACT_ACCOUNT_PAYMENTIN */
...
ALTER PROCEDURE PARAM_FILLPATTERN(I_PARAM_ID TYPE OF ID_PARAM,
I_PATTERN TYPE OF VALUE_ATTR)
 RETURNS(O_PATTERN TYPE OF VALUE_ATTR)
 AS
...
ALTER TABLE ORDERS ALTER COLUMN ADRESS_ID POSITION 6;

ALTER TABLE ORDERS ALTER COLUMN CREATE_DTM POSITION 7;

ALTER TABLE ORDERS ALTER COLUMN STATUS_ID POSITION 8;

ALTER TABLE ORDERS ALTER COLUMN STATUS_DTM POSITION 9;

ALTER TABLE ORDERS ALTER COLUMN BYR2EUR POSITION 10;

ALTER TABLE ORDERS ALTER COLUMN BAR_CODE POSITION 11;

ALTER TABLE ORDERS ALTER COLUMN ACCOUNT_ID POSITION 12;

ALTER TABLE ORDERS ALTER COLUMN USER_SIGN POSITION 13;

ALTER TABLE ORDERTAXS ALTER COLUMN ORDERTAX_ID POSITION 1;

ALTER TABLE ORDERTAXS ALTER COLUMN ORDER_ID POSITION 2;

ALTER TABLE ORDERTAXS ALTER COLUMN TAXRATE_ID POSITION 3;

ALTER TABLE ORDERTAXS ALTER COLUMN PRICE_EUR POSITION 4;

ALTER TABLE ORDERTAXS ALTER COLUMN AMOUNT POSITION 5;

ALTER TABLE ORDERTAXS ALTER COLUMN COST_EUR POSITION 6;

ALTER TABLE ORDERTAXS ALTER COLUMN STATUS_ID POSITION 7;

ALTER TABLE ORDERTAXS ALTER COLUMN STATUS_DTM POSITION 8;

ALTER TABLE PAYMENTS ALTER COLUMN PAYMENT_ID POSITION 1;

ALTER TABLE PAYMENTS ALTER COLUMN MESSAGE_ID POSITION 2;

ALTER TABLE PAYMENTS ALTER COLUMN CREATE_DT POSITION 3;

ALTER TABLE PAYMENTS ALTER COLUMN AMOUNT_BYR POSITION 4;

ALTER TABLE PAYMENTS ALTER COLUMN NOTES POSITION 5;

ALTER TABLE PAYMENTS ALTER COLUMN ORDER_CODE POSITION 6;

ALTER TABLE PAYMENTS ALTER COLUMN STATUS_ID POSITION 7;

ALTER TABLE PAYMENTS ALTER COLUMN STATUS_DTM POSITION 8;
