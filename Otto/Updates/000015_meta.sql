...
/* Create Table... */
CREATE TABLE ORDERHISTORY(ORDER_ID ID_ORDER NOT NULL,
...
CREATE PROCEDURE ORDERHISTORY_UPDATE(I_ORDER_ID TYPE OF ID_ORDER,
...
ALTER TABLE ORDERHISTORY ADD CONSTRAINT FK_ORDERHISTORY_ORDER FOREIGN KEY (ORDER_ID) REFERENCES ORDERS (ORDER_ID) ON UPDATE CASCADE ON DELETE CASCADE;
...
/* Restore proc. body: ORDERHISTORY_UPDATE */
...
/* Create trigger... */
CREATE TRIGGER ORDERHISTORY_BI0 FOR ORDERHISTORY
...
GRANT ALL ON ORDERHISTORY TO SYSDBA WITH GRANT OPTION;
