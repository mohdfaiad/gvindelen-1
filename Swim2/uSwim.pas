...
type
  ...
  private
    ...
    procedure DownloadLeonBetLine(DownloadState: Integer);
    procedure DownloadExpektLine(DownloadState: Integer);
  ...
  private
    ...
    procedure DownloadMarathonLine(DownloadState: Integer);
    procedure DownloadParimatchLine(DownloadState: Integer);
    procedure DownloadUconLine(DownloadState: Integer);
    procedure DownloadBetCityLine(DownloadState: Integer);
    procedure DownloadFavoriteLine(DownloadState: Integer);
    procedure DownloadBetByLine(DownloadState: Integer);
    procedure DownloadPlusMinusLine(DownloadState: Integer);
    procedure DownloadGudBetLine(DownloadState: Integer);
    procedure DownloadBWinLine(DownloadState: Integer);
    procedure DownloadBetAtHomeLine(DownloadState: Integer);
    procedure DownloadBukerLine(DownloadState: Integer);
    procedure CalcWin;
...
uses
  dm, GvinStr, GvHtml, ActiveX, GvinFile,
//  urlmon, wininet,
  DateUtils, GvinMath, GvCloner,
  GvHtmlScript, IdURI, Math,
  uASports, uBSports, uCountrys, uBTournirs, uEvents,
  uAGamers, uBGamers, uUnknowns,
  uRecMarathon, uRecParimatch, uRecFavorit, uRecBetCity,
  uRecUcon, uRecBetBy, uRecPlusMinus, uRecBWin, uRecExpekt, uRecBuker
  , uRecBetAtHome;
...
var
  ...
  vlProxies, vlBookmaker: TVarList;
  Btn: TTBXItem;
